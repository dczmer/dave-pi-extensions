...
export type AstExpansion = AstCommandExpansion | { type: string; [key: string]: unknown };
 ...
 */
export function walkCommands(ast: AstScript, visitor: CommandVisitor, source = ''): void {
  walkNode(ast, visitor, source);
}

function walkNode(node: AstNode, visitor: CommandVisitor, source: string): void {
